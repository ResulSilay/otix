 ...
 *
 * Source: https://github.com/android/snippets/blob/main/compose/recomposehighlighter/src/main/java/com/example/android/compose/recomposehighlighter/RecomposeHighlighter.kt
 */
...
@Stable
fun Modifier.recomposeHighlighter(): Modifier = if (IS_DEBUG) {
